        ...
        <form onSubmit={handleSubmit} className="affiliate-simple-form pt-2">
            <div className="form-section-header mb-4">
                <h5 className="fw-bold text-dark d-flex align-items-center gap-2">
                    ...
                    Referral Partner Identity
                </h5>
                <p className="text-muted small">Create a specialized referral account using standard user credentials.</p>
            </div>
            ...
            <div className="row g-3">
                ...
                <div className="col-md-6">
                    <div className="form-group mb-3">
                        <label className="form-label small fw-bold text-secondary">COMMISSION TYPE</label>
                        <select
                            name="commissionType"
                ...
                <div className="col-md-6">
                    <div className="form-group mb-3">
                        <label className="form-label small fw-bold text-secondary">COMMISSION VALUE</label>
                        <input
                            type="number"
